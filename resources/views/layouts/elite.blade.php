...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <link href="{{ asset('elitedesign/dist/css/style.css') }}" rel="stylesheet">
                    ...
                    <div class="navbar-collapse">
                        ...
                        <ul class="navbar-nav my-lg-0">
                            ...
                            <li class="nav-item dropdown u-pro">
                                <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('Images/avatar.jpg') }}" alt="{{ Auth::user()->name }}" class=""> <span class="hidden-md-down">{{ Auth::user()->name }} &nbsp;<i class="fa fa-angle-down"></i></span> </a>
...
<!--                                    <li><a href="/changePassword"><i class="ti-settings"></i> Change password</a></li>-->
                    ...
                    @if (in_array('ROLE_SALES_MANAGER', Auth::user()->roles) || in_array('ROLE_SALES', Auth::user()->roles) || in_array('ROLE_TECHNICAL_MANAGER', Auth::user()->roles) || in_array('ROLE_TECHNICAL', Auth::user()->roles) )   
                    ...
                    @endif
                            ...
                            @endif
                            @if (in_array('ROLE_OPERATION_SUPERVISER', Auth::user()->roles) || in_array('ROLE_OPERATION_LEAD', Auth::user()->roles))   

                            <li> <a class="waves-effect waves-dark" href="{{ route('incompleterequest') }}" aria-expanded="false"><i class="far fa-circle text-info"></i><span class="hide-menu">Waiting for INSLY update</span></a></li>
...
<!--                                    <li> 
        ...
        <!--Menu sidebar -->
        <script src="{{ asset('elitedesign/dist/js/sidebarmenu.js') }}"></script>
        <!--Custom JavaScript -->
        <script src="{{ asset('elitedesign/dist/js/custom.js') }}"></script>
