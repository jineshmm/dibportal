...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Filters</h4>
            ...
            {{ Form::open(array('route' => 'financeproductionfilter', 'name' => 'salesrequestfilter','id'=>'salesrequestfilter','class'=>'') ) }}
            <div class="form-group mt-5 row">
                <label for="example-text-input" class="col-2 col-form-label">Inception date period</label>
                <div class="col-5">
                    <input class="form-control" type="date" value="" id="ins_startDate" name='ins_startDate'>
                </div>
                <div class="col-5">
                    <input class="form-control" type="date" value="" id="ins_endDate" name='ins_endDate'>
                </div>
            </div>
...
<div class=" card">
 ...
 <a href="{{ route('productionreportexport')}}"><button type="button" class="btn btn-info d-none d-lg-block m-l-15 pull-right"><i class="mdi mdi-file-export"></i> Export</button></a>
