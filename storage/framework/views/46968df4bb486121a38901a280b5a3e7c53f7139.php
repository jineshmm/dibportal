            ...
            <div class="card-body"> 
                <div class="panel-heading">
                    <ul class="panel-actions list-inline pull-right">
                        <li class="dpib_customer_document_add" policy-id="<?php echo e($policyId); ?>"><span class="panel-action-add"  data-toggle="tooltip" title="Add a document" ><span class="fas fa-plus text-blue"></span></span>
                        </li>  
                    </ul> 
             ...
             columnDefs.push({"name": "comment", "targets": 2, "orderable": false, data: function (row, type, val, meta) {
                ...
                fileName = row['file_name'];
                            ...
                            if(jQuery.inArray(fileExtension.toLowerCase(), extensionArray) !== -1){
                               var link ='<a href="<?php echo url("/"); ?>/uploads/'+row['customer_id']+'/document/'+policyId+'/'+ fileName +'" class="dib-cursor-style"  target="_blank" style="margin-left:3px"><span class="fas fa-eye text-blue mr-right" data-toggle="tooltip" title="" data-original-title="Preview file"></span></a>';
                              displayAction += link; 
                            }
               ...
               var that = $(this);
                    $.ajax({
                url: "<?php echo route('customerdocaddform',$customerId); ?>",
                        type: "GET"
                        ...
                        "Delete": {
                            ...
                            click: function () {
                                DIB.progressDialog(LOCALE.get('dib.common.progress.loading'));
                                 $.ajax({
                url: "<?php echo route('customerdocdelete',$customerId); ?>",
                        headers: {
...
</script><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Policy/documentData.blade.php ENDPATH**/ ?>