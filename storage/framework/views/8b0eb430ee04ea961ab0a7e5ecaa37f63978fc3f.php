...
<!--                 <link rel="stylesheet" href="<?php echo e(asset('css/dibstyle.css')); ?>">-->
        <link href="<?php echo e(asset('elitedesign/dist/css/fullwidthstyle.css')); ?>" rel="stylesheet">
        <link rel="stylesheet" href="<?php echo e(asset('elitedesign/assets/node_modules/jqueryui/jquery-ui.min.css')); ?>">
         ...
         <link type="text/css" href="<?php echo e(asset('elitedesign/fullwidth/css/tab-page.css')); ?>" type="text/css" rel="stylesheet" />
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="<?php echo e(asset('Images/avatar.jpg')); ?>" alt="<?php echo e(Auth::user()->name); ?>" class=""> <span class="hidden-md-down"><?php echo e(Auth::user()->name); ?><i class="fa fa-angle-down"></i>
                                </span> </a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <?php endif; ?>
                            ...
                            <li> <a class="waves-effect waves-dark" href="<?php echo e(route('salescrmlist')); ?>" aria-expanded="false"><i class="far fa-circle text-info"></i><span class="hide-menu">Requests</span></a></li>
...
<!--                                    <li> 
                        ...
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <ol class="breadcrumb">
                               ...
                               <?php if(isset($breadcrumb)): ?>
                                <li class="breadcrumb-item active"><a href="<?php echo e($breadcrumb['url']); ?>" class='breadcrumb_active'><?php echo e($breadcrumb['title']); ?></a></li>
                                <?php endif; ?>
    ...
    <!-- ============================================================== -->
     <script src="<?php echo e(asset('elitedesign/assets/node_modules/jquery/jquery-3.2.1.min.js')); ?>"></script>
        ...
        <!--Menu sidebar -->
        <script src="<?php echo e(asset('elitedesign/fullwidth/js/sidebarmenu.js')); ?>"></script>
        <!--Custom JavaScript -->
        <script src="<?php echo e(asset('elitedesign/dist/js/custom.min.js')); ?>"></script>
        <!-- ============================================================== -->
