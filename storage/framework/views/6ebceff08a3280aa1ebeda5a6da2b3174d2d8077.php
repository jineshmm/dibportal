...
<?php echo e(Form::open(array('route' => 'updatepolicyinfo', 'name' => 'savepolicyForm','id'=>'savepolicyForm','class'=>'dpib-custom-form') )); ?>
                ...
                <table class="insly-form">
                    <tbody>
                        <tr id="field_customer_oid" class="field">
                            ...
                            <td>
                                <div class="element">
                                    <input type='hidden' name='policy_id' value='<?php echo e($policyData->mainId); ?>' >
                                    <?php echo e(Form::select('customer_id',  $allCustomers, $policyData->customer_id,array('name'=>'customer_id','id' =>'customer_id','required'=>'required','class'=>'required form-control','error-message' =>"Insurance company field is mandatory"))); ?>
            ...
            <div class="panel-body" id="fieldgroup_policy">
                <table class="insly-form">
                    <tbody>
                            ...
                            <td><div class="element"><input type="text" class="form-control" id="policy_number" name="policy_number" value="<?php echo e($policyData->policy_number); ?>" maxlength="10" autocomplete="off"  style="margin-right: 0px !important" ></div></td>
                           </tr>
                            ...
                            <td>
                                <div class="element">
                                    <select id="policy_type" name="policy_type" class="form-control" >
                                        <option value="1" <?php echo e(isset($policyData->policy_type) ? (($policyData->policy_type=="0")? 'selected':''): ''); ?>>General</option>

                                        <option value="2" <?php echo e(isset($policyData->policy_type) ? (($policyData->policy_type=="1")? 'selected':''): ''); ?>>Medical</option>

                                        <option value="3" <?php echo e(isset($policyData->policy_type) ? (($policyData->policy_type=="2")? 'selected':''): ''); ?>>Motor</option>
                        ...
                        <tr id="field_policy_insurer" class="field ">
                            ...
                            <td>
                                <div class="element">
                                    ...
                                    <?php echo e(Form::select('insurance_company',  $insurancecompany, $policyData->insurer_id,array('name'=>'policy_insurer','id' =>'policy_insurer','required'=>'required','class'=>'required form-control','error-message' =>"Insurance company field is mandatory" ))); ?>  
                            ...
                            <td>
                                <div class="element">
                                    <select id="policy_salestype" name="policy_salestype" class="form-control">
                                        ...
                                        <option value="1" <?php echo e(isset($policyData->sales_type) ? (($policyData->sales_type=="1")? 'selected':''): ''); ?>>new sales</option>

                                        <option value="2" <?php echo e(isset($policyData->sales_type) ? (($policyData->sales_type=="2")? 'selected':''): ''); ?>>renewal</option>

                                        <option value="3" <?php echo e(isset($policyData->sales_type) ? (($policyData->sales_type=="3")? 'selected':''): ''); ?>>manual renewal</option>
                            ...
                            <td>
                                <div class="element">
                                    <select id="policy_renewalstatus" name="policy_renewalstatus" data-default-value="0" class="form-control">
                                        <option value="0" <?php echo e(isset($policyData->renewal_status) ? (($policyData->renewal_status==0)? 'selected="selected"':''): ''); ?>>No</option>

                                        <option value="1" <?php echo e(isset($policyData->renewal_status) ? (($policyData->renewal_status==1)? 'selected':''): ''); ?>>Yes</option>
...
<?php echo $__env->make('layouts.elite_fullwidth',['sidemenustatus' => array(),'countDetails'=>array(),'notificationCount'=>array() ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Policy/editPolicyForm.blade.php ENDPATH**/ ?>