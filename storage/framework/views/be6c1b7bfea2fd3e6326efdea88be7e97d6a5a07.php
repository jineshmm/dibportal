...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Filters</h4>
            ...
            <?php echo e(Form::open(array('route' => 'installmentfilter', 'name' => 'salesrequestfilter','id'=>'salesrequestfilter','class'=>'') )); ?>
            ...
            <div class="form-group row ui-widget">
              ...
              <div class="form-group row">
                ...
                <div class="col-10">
                    ...
                    <?php echo e(Form::select('intallment_type', [''=>'---Select---']+ $statusArray,  '' ,array('id' =>'intallment_type','class'=>'custom-select col-12','error-message' =>"Paid type field is mandatory" ))); ?>  
                </div>
            </div>
            ...
            <button type="button" class="btn btn-dark" id='filterCancel' redirectUrl='<?php echo e(route('installmentreport')); ?>'>Cancel</button>
...
<?php if(isset($installmentDetails)): ?>
<div class=" card">
    <div class="card-body">
        
 <a href="<?php echo e(route('installmentexport')); ?>"><button type="button" class="btn btn-info d-none d-lg-block m-l-15 pull-right"><i class="mdi mdi-file-export"></i> Export</button></a>
   ...
   $(function(){
    ...
    <?php if(isset($installmentDetails)): ?>
      ...
      complaintTable =   $('.dpib_policy_list').DataTable( {
                data: <?php echo $installmentDetails; ?>,
                autoWidth: true,
                stateSave: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.elite',['notificationCount'=>0 ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Reports/financeinstallment.blade.php ENDPATH**/ ?>