                                        ...
                                        <tbody>
                                            <tr>
                                               ...
                                               <td id="filter_customer_type" class="extend-filter filterlevel2"><div><label for="filter_customer_type">Remaining days:</label><div>
                                                           <?php echo e(Form::select('filter_remaining_days',[''=>'---- not set ----'] +   [''=>'--- all ---','20'=>20,'40'=>40,'60'=>60], isset($formData['filterdays']) ? $formData['filterdays']:'' ,array('id' =>'filter_remaining_days',"error-message"=>'Account manager field is mandatory'))); ?> 
...
$(document).on('click','#mg_clear_filter',function(){
   window.location.href = "<?php echo route('renewalnotificationlist'); ?>";
