...
<div class="row">
    ...
    <div class="col-md-12 card">
        ...
        <ul class="nav nav-tabs customtab card-body" role="tablist">
            ...
            <li id="tab_log" class="nav-item <?php echo e(!empty($overviewTab) && $overviewTab == 'log' ? 'active' : ''); ?>" onclick="TAB.select('log', null, 0); customerLogTable.columns.adjust().draw();"> <a class="nav-link <?php echo e(empty($overviewTab) || $overviewTab == 'log' ? 'active' : ''); ?>" data-toggle="tab" href="#content_log" role="tab" aria-selected="false"><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">Log</span></a> </li>
            ...
            <div id="main-content" class="col-md-8" >
                <div id="panel-customer_overview" class="panel panel-default open"><div class="panel-heading">
                        ...
                        <ul class="panel-actions list-inline pull-right">
                            <?php if(in_array('ROLE_OPERATION_MANAGER', Auth::user()->roles) ||  Auth::user()->id == $overviewData->created_by || Auth::user()->id == $overviewData->assign_to): ?>
                            <li class="dpib_endorsement_request_edit dib-cursor-style" editUrl='<?php echo route("editcrmrequestdata",[$policyId, $requestId]); ?>'><span class="fas fa-edit text-blue" data-toggle="tooltip" title="" data-original-title="Edit CRM"></span></li>
                            <?php endif; ?> 
                            ...
                            <li class="dpib_endorsement_crm_delete dib-cursor-style dib-delete-icon" delete_url="<?php echo route('deleteendorsementcrmrequest',$requestId); ?>" return-url="<?php echo route('dashboardendorsementlist'); ?>"><span class="fas fa-archive text-blue" data-toggle="tooltip" title="" data-original-title="Remove request"></span></li>
                            <?php endif; ?>
                        </ul>
                        <?php endif; ?>
                    ...
                    <div id="customer_overview" class="panel-collapse panel-body ">
                        <table class="info-table" width='100%'>
                            <tbody>
                                <tr><td>CRM No:</td><td><b><?php echo e($overviewData->request_id); ?></b></td></tr>
                                <tr><td>Type:</td><td><?php echo e($typeArray[$overviewData->type]); ?> </td></tr>
                                <tr><td>Policy no:</td><td><b><?php echo e($overviewData->policy_number); ?></b></td></tr>
                                <tr><td>Customer:</td><td><b><?php echo e($overviewData->customerName); ?></b></td></tr>
                                <tr><td>Created By:</td><td><?php echo e($overviewData->userName); ?></td></tr>
                                <?php if($overviewData->assign_to !=null): ?>
                                <tr><td>Assign to :</td><td><?php echo e($overviewData->AssignName); ?></td></tr>
                                <?php endif; ?>
                                <tr><td>Created date:</td><td><?php echo e(date("d.m.Y h:i",strtotime($overviewData->created_at))); ?> </td></tr>

                                <tr><td>Description:</td><td><?php echo e($overviewData->description); ?></td></tr> 
                                <?php if(in_array($overviewData->type, [1,3,4,9])): ?>
                                <tr ><td>Is Invoice recieved ?</td><td><div class="custom-control custom-switch">
                                            <input type="checkbox" changeUrl='<?php echo route("updateinvoiceflag",[$policyId,$requestId]); ?>' class="custom-control-input" id="customSwitch1" <?php if($overviewData->inv_flag ==1): ?>   checked <?php endif; ?> <?php if($overviewData->status ==3): ?>   disabled <?php endif; ?>>
                                                   <label class="custom-control-label" for="customSwitch1"></label>
                                        </div></td>
                                </tr>
                                <tr ><td>Is INSLY entered ?</td><td><div class="custom-control custom-switch">
                                            <input type="checkbox" changeUrl='<?php echo route("updateinslyflag",[$policyId,$requestId]); ?>' class="custom-control-input" id="customSwitch3" <?php if($overviewData->is_insly_entered ==1): ?>   checked <?php endif; ?> >
                                ...
                                <tr ><td>Is the invoice related to multiple request?</td><td><div class="custom-control custom-switch">
                                            <input type="checkbox" changeUrl='<?php echo route("updateinvoiceflag",[$policyId,$requestId]); ?>' class="custom-control-input" id="customSwitch2" <?php if($overviewData->is_invoice_related ==1): ?>   checked <?php endif; ?>  <?php if($overviewData->status ==3): ?>   disabled <?php endif; ?>>
                                                   <label class="custom-control-label" for="customSwitch2"></label>
                                        </div></td>
                                </tr>
                                <?php endif; ?>
                                <?php if(!empty($overviewData->related_request)): ?>
                                <?php
                                $requestdataArray = explode('###',$overviewData->related_request);  

                                ?>
                                <tr><td>Related request:</td><td><a href='<?php echo route("overviewendorsementcrmrequest",[$policyId,$requestdataArray[0]]); ?>' target="_blank"><?php echo e($requestdataArray[1]); ?></a></td></tr>


                                <?php endif; ?>

                                <?php if($overviewData->inv_flag ==1): ?> 

                                <tr><td>Invoice recieved date:</td><td><?php echo e(date("d.m.Y",strtotime($overviewData->inv_recieved_date))); ?></td></tr>  
                                ...
                                <tr><td>Last modified date:</td><td class="phoneNumber"><?php echo e(date("d.m.Y h:i",strtotime($overviewData->updated_at))); ?></td></tr>
                                 <?php if($overviewData->is_insly_entered ==1): ?>
                                <tr><td>Insly entered date:</td><td><?php echo e(date("d.m.Y",strtotime($overviewData->insly_entered_date))); ?></td></tr>
                                <?php endif; ?>
                                ...
                                <tr>
                                    <td>
                                        <span class='text-warning'> 
                                            <?php if(!empty($commentDetail->created_user)): ?>
                                            <?php echo e($commentDetail->created_user); ?>

                                            <?php else: ?>
                                            <?php echo e($commentDetail->createdBy); ?>

                                            <?php endif; ?>


                                        </span><span style="margin-left:10px" class="text-warning">: <?php echo e(date('d.m.Y H:i',strtotime($commentDetail-> created_at))); ?></span><br />
                                        <span style="margin-left:10px"><i>Message:&nbsp;&nbsp;   <?php echo e($commentDetail->comments); ?></i></span></td></tr>
...
<script id='request_status_template' type='text/template'>
    ...
    <?php echo e(Form::open(array('route' => array('updateendorsementrequeststatus',$policyId), 'name' => 'form_endorsement_request_status_edit','id'=>'form_endorsement_request_status_edit','files'=>'true' ))); ?>
    ...
    <div class="element">
    <input type='hidden' name='crm_request_id' value='<?php echo e($overviewData->id); ?>'>
    <?php echo e(Form::select('request_status',  $statusArray, $overviewData->status,array('id' =>'request_status','required'=>'required','class'=>'required form-control','error-message' =>"Gender field is mandatory" ))); ?>  
    </div>
    </td>
    </tr>
...
<script id='request_document_upload_template' type='text/template'>
    <?php echo e(Form::open(array('route' => array('endorsementcrmdocumentsave', $overviewData->id), 'name' => 'form_document_add','id'=>'form_document_add','files'=>'true' ))); ?>
    ...
    <?php echo e(Form::select('documenttype_oid',[''=>'--- other ---'] +  $documentType, null,array('id' =>'documenttype_oid','required'=>'required','class'=>'required form-control','error-message' =>"Gender field is mandatory" ))); ?>  
    </div>
    </td>
    </tr>
...
<script id='comment_add_template' type='text/template'>
    ...
    <?php echo e(Form::open(array('route' => array('saveendorsementcomments',$policyId,$overviewData->id), 'name' => 'form_claimant_add','id'=>'form_claimant_add','files'=>'true' ))); ?>
    ...
    <td></td>
    <td>
    <input type="hidden" id="crm_end_request_id" name="endorsement_request_id" value="<?php echo e($overviewData->id); ?>">
    </td>
    </tr>
...
<script id='request_connection_template' type='text/template'>
    <?php echo e(Form::open(array('route' => array('changeconnectionflag', $overviewData->id), 'name' => 'form_request_connection','id'=>'form_request_connection','files'=>'true' ))); ?>
    ...
    <?php echo e(Form::select('connected_request[]',  $relatedrequests, '',array('id' =>'connected_request','required'=>'required','multiple'=>'multiple','class'=>'required form-control','error-message' =>"Request field is mandatory" ))); ?>  
    </div>
...
<script id='endorsement_request_assign_template' type='text/template'>
    ...
    <?php echo e(Form::open(array('route' => array('assignndorsementcrmrequest',$overviewData->id), 'name' => 'form_endorsement_request_assign','id'=>'form_endorsement_request_assign','files'=>'true' ))); ?>
...
<script>
                                    ...
                                    width: 900,
                                            ...
                                            <?php if(in_array($overviewData -> type, [1, 3, 4, 9]) && $overviewData -> inv_flag == 0 ): ?>
                                    ...
                                    if(jQuery.inArray(fileExtension.toLowerCase(), extensionArray) !== -1){
                                       var link ='<a href="<?php echo url("/"); ?>/uploads/'+customerId+'/document/'+ fileName +'" class="dib-cursor-style"  target="_blank" style="margin-left:3px"><span class="fas fa-eye text-blue mr-right" data-toggle="tooltip" title="" data-original-title="Preview file"></span></a>';
                                      displayAction += link; 
                                    }
                                    ...
                                    width: 900,
                                            ...
                                            class: "btn waves-effect waves-light btn-rounded btn-success",
                                                    ...
                                                    DIB.progressDialog(LOCALE.get('dib.common.progress.loading'));
                                                    $.ajax({
                                                    url: "<?php echo route('endorsementcrmdocumentremove',$overviewData->id); ?>",
                                                            type: "GET",
                                                            data:formdata
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.elite_fullwidth',['sidemenustatus' => array(),'countDetails'=>array(),'notificationCount'=>array() ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Policy/overviewendorsementrequest.blade.php ENDPATH**/ ?>